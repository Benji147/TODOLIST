...
describe('controller', function () {
    ...
    describe('toggle all', function () {
        it('should toggle all todos to completed', function () {
            // TODO: write test
            var todo = {id: 38, title: 'my todo', completed: false};
            setUpModel([todo]);

            subject.setView('');
            view.trigger('toggleAll', {completed: true});

            expect(model.update).toHaveBeenCalledWith(38, {completed: true}, jasmine.any(Function));
        });
        ...
        it('should update the view', function () {
            ...
            expect(view.render).toHaveBeenCalledWith('elementComplete', {id:38, completed: true});
        });
    });
